...
mu1 = 5^2;
[Af,Bf,Cf,Df] = filterRight(Ar,B1,B2,C,D1r,D2r,mu1);
...
mu2 = 5^2;
[Af,Bf,Cf,Df] = filterLeft(Al,B,C1,C2,D1l,D2l,mu2);
...
%% Joint filtering
[Af,Bf,Cf,Df,mu1,mu2] = filterJoint(P,H);
Fjoint  = ss(Af,Bf,Cf,Df,-1);

% hinf test
[hinfnorm(Fl),hinfnorm(Fr),hinfnorm(Fjoint)]
